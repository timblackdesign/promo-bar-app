...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', '343fae85673dabbe79fdb346dc361e1a'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '3d45d5d0575e991e95eafeb2d54d182f'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_content,write_content,read_themes,write_themes,read_script_tags,write_script_tags'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://edcf25f3.ngrok.io/webhook/app-uninstalled')
        ],
    ],
